            ...
            <div class="col-xl-7 col-lg-8 col-md-9">
                <nav class="mb-4" style="--bs-breadcrumb-divider: '>';" aria-label="breadcrumb">
                    <ol class="breadcrumb mb-0">
                        ...
                        <li class="breadcrumb-item active"><a href="{{ route('admin.restaurants.show', ['restaurant' => $id]) }}">店舗詳細</a></li>
                ...
                <form method="POST" action="{{ route('admin.restaurants.update', ['restaurant' => $id]) }}" enctype="multipart/form-data">
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" id="name" name="name" value="{{ old('name', $restaurants->name) }}">
                        </div>
                    </div>
                    ...
                    @if ($restaurants->image !== '')
                        <div class="row" id="imagePreview"><img src="{{ asset('storage/restaurants/'. $restaurants->image) }}" class="mb-3"></div>
                    @else
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <textarea class="form-control" id="description" name="description" cols="30" rows="5">{{ old('description', $restaurants->description) }}</textarea>
                        </div>
                    </div>
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="lowest_price" name="lowest_price">
                                ...
                                @for ($i = 0; $i < 20; $i++)
                                    ...
                                    @if ($lowest_price == old('lowest_price', $restaurants->lowest_price))
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="highest_price" name="highest_price">
                                ...
                                @for ($i = 0; $i < 20; $i++)
                                    ...
                                    @if ($highest_price == old('highest_price', $restaurants->highest_price))
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" id="postal_code" name="postal_code" value="{{ old('postal_code', $restaurants->postal_code) }}">
                        </div>
                    </div>
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <input type="text" class="form-control" id="address" name="address" value="{{ old('address', $restaurants->address) }}">
                        </div>
                    </div>
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="opening_time" name="opening_time">
                                ...
                                @for ($i = 0; $i < 48; $i++)
                                    ...
                                    @if ($opening_time == old('opening_time', date('H:i', strtotime($restaurants->opening_time))))
                        ...
                        <div class="col-md-7">
                            <select class="form-control form-select" id="closing_time" name="closing_time">
                                ...
                                @for ($i = 0; $i < 48; $i++)
                                    ...
                                    @if ($closing_time == old('closing_time', date('H:i', strtotime($restaurants->closing_time))))
                    ...
                    <div class="form-group row mb-3">
                        ...
                        <div class="col-md-7">
                            <input type="number" class="form-control" id="seating_capacity" name="seating_capacity" value="{{ old('seating_capacity', $restaurants->seating_capacity) }}">
                        </div>
                    </div>
