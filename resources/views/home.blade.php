                    ...
                    <a href="{{ route('restaurants.show', $highly_rated_restaurant) }}" class="link-dark nagoyameshi-card-link">
                        <div class="card h-100">
                            @if ($highly_rated_restaurant->image !== '')
                                ...
                                <img src="{{ Storage::disk('s3')->temporaryUrl('/' . $highly_rated_restaurant->image,now()->addDay()) }}" alt="Restaurant Image" class="w-100">
                                {{-- <img src="{{ Storage::disk('s3')->temporaryUrl('/' . $highly_rated_restaurant,now()->addDay()) }}" alt="Restaurant Image" class="w-100"> --}}
                            @else
                    ...
                    <a href="{{ route('restaurants.show', $new_restaurant) }}" class="link-dark nagoyameshi-card-link">
                        <div class="card h-100">
                            @if ($new_restaurant->image !== '')
                                ...
                                <img src="{{ Storage::disk('s3')->temporaryUrl('/' . $new_restaurant->image,now()->addDay()) }}" alt="Restaurant Image" class="w-100">
                            @else
                                <img src="{{ asset('/images/no_image.jpg') }}" class="card-img-top nagoyameshi-vertical-card-image" alt="画像なし">
                            @endif
                            <div class="card-body">
